...
With just these four functions we can start to edit our image quite dramatically and they give us the power to fix a lot of issues that can arise when taking photos. But we're just getting started with what we can do with GLSL. In the [next article](/p/2023-06-webgl-03-hue) we'll take a look at how to we can morph the colors with hue adjustments.
