...
But we're just getting started with what we can do with GLSL. In the [next article](/p/2023-06-webgl-03-hue) we'll take a look at how to we can morph the colors with hue adjustments.
