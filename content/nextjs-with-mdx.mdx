...
I'm intending to start writing a lot more articles on this site, so for this rebuild I wanted to keep the layout completely separate from the article content. This will enable me to update the site layout within updating the articles themselves.
