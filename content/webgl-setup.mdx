...
This program doesn't do much at the moment. It simply outputs the image we pass in, as we can see below. In the [next article](/p/webgl-color-correction) we’ll expand on this basic program to support color correction methods such as brightness, exposure and saturation.
