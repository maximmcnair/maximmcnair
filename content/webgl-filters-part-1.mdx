...
We'll start by looking at some basic color correction functions like brightness, contrast, exposure and saturation. Along with a basic intro to WebGL (Web Graphics Library) and GLSL (OpenGL Shading Language) shaders. I won't go deeply into the WebGL side here, but I'll leave some resources at the end of the articles.
