...
Image convolution is the process of modifying an image by convolving it by a kernel matrix (this is not the same as a dither matrix we covered previously). Depending on the matrix chosen we can achieve effects such as embossing, outlining, blurring and sharpening.
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
  ...
  <small style={{marginTop: 5}}>
    [Convolution of two functions (Wolfram MathWorld)](https://mathworld.wolfram.com/Convolution.html)
  </small>
</div>
