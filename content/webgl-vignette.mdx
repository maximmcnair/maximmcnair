...
The main issue with the above approach is that we lose a lot of detail from the center of the image. We can use smoothstep to control the "smoothness" of the fade between our image and the darkness at the edges. 
...
In the next article, we'll be exploring how to simulate the effect of [chromatic aberration](/p/webgl-chromatic-aberration).
